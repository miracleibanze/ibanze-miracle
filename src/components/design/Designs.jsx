...
export const BackgroundCircles = ({ parallaxRef }) => {
  ...
  return (
    <div className="absolute max-w-[80%] left-[10%] mx-auto top-10 lg:-top-[20rem]  w-[78rem] aspect-square -z-[9999] bg-n-8 overflow-visible max-md:hidden">
      <Rings />
      ...
      <MouseParallax strength={0.07} parallaxContainerRef={parallaxRef}>
        <div className="absolute bottom-1/2 left-1/2 w-0.25 h-1/2 origin-bottom -rotate-[85deg]">
          <div
            className={`w-6 h-6 -ml-3 -mt-3 bg-gradient-to-b from-[#f55492] to-[#1A1A32] rounded-full transition-transform duration-500 ease-out ${
        ...
        <div className="absolute bottom-1/2 left-1/2 w-0.25 h-1/2 origin-bottom rotate-[70deg]">
          ...
          <div className="absolute bottom-1/2 left-1/2 w-0.25 h-1/2 origin-bottom rotate-[70deg]">
            <div
              className={`w-6 h-6 -ml-3 -mt-3 bg-gradient-to-b from-[#717723] to-[#1A1A32] rounded-full transition-transform duration-500 ease-out ${
                mounted
...
export const Image = () => {
  return (
    <>
      <div className="h-full w-full rounded-3xl bg-n-5 pointer-events-none">
        <div className=" absolute z-10 w-[4rem] bottom-[8rem] -right-10 bg-color-4 aspect-square rounded-full" />
        <div className=" absolute z-20 w-[2rem] -bottom-10 left-1/2 bg-color-4 aspect-square rounded-full" />
      </div>
    </>
  );
};
